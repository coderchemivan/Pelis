...
import pandas as pd
from mongoDB_scripts.db_admon import Admon_bd
...
class Imdb (CrawlSpider):
    ...
    def parse_titles(self, response):
        ...
        c = Admon_bd('cluster0', 'bleistift16', 'movies', 'Titulos')
        encontrado = c.find_({"id_imdb": id_imdb}
                )
        if encontrado != 1:
            try:
